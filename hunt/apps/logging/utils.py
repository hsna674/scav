    ...
    try:
        ...
        try:
            ...
            if is_first_overall:
                ...
                # Send Discord notification in background thread to avoid blocking submission
                discord_thread = Thread(
                    target=send_first_blood_notification,
                    args=(user, challenge, class_year, points_earned),
                    daemon=True,
                )
